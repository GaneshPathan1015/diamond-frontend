            ...
            <section>
                ...
                <div className="container" style={{ paddingTop: '100px' }}>
                    <div style={{
                        ...
                        <h1 style={{ color: '#000' }}>With Clarity <br />
                ...
                <div className="container text-center">
                    ...
                    >
                        ...
                        >
                            ...
                            <p style={{ fontSize: "15px" }}>At checkout, select With Clarity Credit <br />  Card as your payment option.</p>
                        </div>
                        ...
                        >
                            ...
                            <p style={{ fontSize: "15px" }}>Apply for With Clarity Credit <br />  Card</p>
                        </div>
                    ...
                    <div style={{ paddingTop: '60px', textAlign: 'center' }}>
                        ...
                        <h1 className='pb-4'>With Clarity credit card</h1>
                        <div className="row text-center">
                            <div className="col-md-6">
                                <h2>Non-Promotional Financing Available</h2>
                                <p>Purchases subject to credit approval and the standard terms of <br />your With Clarity account.</p>
                            </div>
                    ...
                    <div className="faq-section">
                        ...
                        <div className="accordion" id="faqAccordion">
                            ...
                            <div className="accordion-item">
                                <h2 className="accordion-header" id="heading1">
                                    <button
                                        ...
                                        data-bs-target="#faq1"
                                    >
                                        What is the With Clarity store credit card?
                                    </button>
                                </h2>
                                <div
                                    id="faq1"
                                ...
                                >
                                    <div className="accordion-body">
                                        With Clarity offers customers a credit card through Synchrony Bank with a revolving credit line to use again and again at withclarity.com.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="accordion-item">
                                ...
                                >
                                    <div className="accordion-body">
                                        You can apply for a With Clarity Store Credit Card
                                    </div>
                                </div>
                            </div>
