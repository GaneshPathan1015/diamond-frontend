      ...
      <section style={{ background: "#213245", marginBottom: "80px" }}>
        <div className="container text-center">
          <div style={{ padding: "24px 0" }}>
            ...
            >
              Enjoy a personalized experience with a jewelry specialist, by
              appointment only.
            </p>
            <h4
              style={{
            ...
            >
              {" "}
              118 SPRING ST. NEW YORK, NY 10012
            </h4>
          </div>
        </div>
      </section>
                ...
                <div className="accordion-item border-0">
                  ...
                  >
                    <div className="accordion-body">
                      Clients will have the opportunity to explore a curated
                      collection of diamonds. We will offer ready to wear lab
                      diamond jewelry for purchase, such as studs, bracelets,
                      and pendant necklaces. Our showcases feature signature
                      designs with jewelry from The Ceramic Series, The Luxe
                      Collection, and The Reserve.
                    </div>
                  </div>
                </div>
                <div className="accordion-item border-0">
                  ...
                  >
                    <div className="accordion-body">
                      Explore the world of diamonds in a fun, welcoming
                      environment. Get to understand and discover what you love
                      before you purchase. Come curious and ask away. Your
                      jewelry specialist is here to answer all questions and
                      will ensure that you have a comprehensive understanding
                      while navigating all of the different elements.
                    </div>
                  </div>
                </div>
                <div className="accordion-item border-0">
                  ...
                  >
                    <div className="accordion-body">
                      Your one-on-one appointment includes a jewelry specialist
                      to assist you. This is an immersive experience. You will
                      be seated at a private table to feel at ease throughout
                      the entirety of your reservation. Your jewelry specialist
                      will be your guide and walk you through a detailed process
                      based on your personal preferences. We are excited to
                      create a memorable experience for you.
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 d-flex flex-column justify-content-center">
              ...
              <p>
                Our virtual appointments make the With Clarity showroom
                experience accessible to all. Your jewelry specialist will have
                a dual-camera setup ensuring a seamless and immersive journey.
                Each virtual appointment follows the same structure as our
      ...
      <section className="radiance-features py-4 py-md-5">
        ...
        <div className="container">
          <div className="row justify-content-center align-items-center text-center">
            {/* Item 1 */}
            <div
              className="col-6 col-md-2 mb-4 radiance-feature-item"
