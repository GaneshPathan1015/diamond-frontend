                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-6 d-flex flex-column justify-content-center" >
                            ...
                            <p>Our virtual appointments make the With Clarity showroom experience accessible to all. Your jewelry specialist will have a dual-camera setup ensuring a seamless and immersive journey. Each virtual appointment follows the same structure as our in-person appointments.</p>
                        </div>
                    </div>
                </div>
            </section>
