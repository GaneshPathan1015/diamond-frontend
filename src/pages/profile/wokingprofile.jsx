      ...
      case "financing":
        return (
          <div className="tab-content-box">
            ...
            <p>Explore financing options for your purchases.</p>
          </div>
        );
  ...
  return (
    <>
      ...
      <div className="container-fluid my-account-container">
        <div className="row">
          {/* Sidebar */}
          <div className="col-lg-3 col-md-4 col-12 sidebar mb-3">
            ...
            <button className="btn btn-dark w-100 mt-4">LOG OUT</button>
          </div>
