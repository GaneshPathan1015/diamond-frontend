...
export default function RingStyle() {
  return (
    <>
      {/* Hero Section */}
      <section className="gemstones_hero d-flex flex-column justify-content-center align-items-center text-center" style={{backgroundImage:'url("/images/engagementringstyle/1.webp")'}}>
      ...
      <section className="pt-5">
        <div className="container">
          ...
          <nav className="top-nav">
            <a href="#" className="active">ENGAGEMENT RINGS</a><span>|</span>
            ...
            <div className="col-md-9">
              ...
              <div className="main-content">
                ...
                <div className="gemstone-details">
                  ...
                  <img src="/images/engagementringstyle/2.jpg" alt="Garnet gemstone" className="gemstone-img" />
                </div>
                <div className="related-posts">
                  <h2>RELATED POSTS</h2>
                  <ul>
                    <li><a href="#">Halo vs. Solitaire – Which engagement ring style should you pick?</a></li>
                    <li><a href="#">Solitaire Engagement Rings</a></li>
                    <li><a href="#">Which Hand Does the Engagement Ring Go On?</a></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="main-content">
                ...
                <div className="gemstone-details">
                  ...
                  <img src="/images/engagementringstyle/3.jpg" alt="Amethyst gemstone" className="gemstone-img" />
                </div>
                <div className="related-posts">
                  <h2>RELATED POSTS</h2>
                  <ul>
                    <li><a href="#">About Halo Diamond Engagement Rings</a></li>
                    <li><a href="#">What Is a Cushion Halo Ring? Is It The Same As a Cushion Cut Ring?</a></li>
                    <li><a href="#">Best Vintage Halo Diamond Engagement Rings</a></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="main-content">
                ...
                <div className="gemstone-details">
                  ...
                  <img src="/images/engagementringstyle/4.jpg" alt="Aquamarine gemstone" className="gemstone-img" />
                </div>
                <div className="related-posts">
                  <h2>RELATED POSTS</h2>
                  <ul>
                    <li><a href="#">Unique Vintage Diamond Engagement Rings</a></li>
                    <li><a href="#">Best Vintage Oval Engagement Rings</a></li>
                    <li><a href="#">Best Vintage Halo Diamond Engagement Rings</a></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="main-content">
                ...
                <div className="gemstone-details">
                  ...
                  <img src="/images/engagementringstyle/5.jpg" alt="Diamond gemstone" className="gemstone-img" />
                </div>
                <div className="related-posts">
                  <h2>RELATED POSTS</h2>
                  <ul>
                    <li><a href="#">All About Grace Kelly’s Engagement Ring</a></li>
                    <li><a href="#">All About Jessica Biel’s Engagement Ring</a></li>
                    <li><a href="#">How Much Should An Engagement Ring Cost? (Hint: The Old Rule Is Outdated)</a></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="main-content">
                ...
                <div className="gemstone-details">
                  ...
                  <img src="/images/engagementringstyle/6.jpg" alt="Emerald gemstone" className="gemstone-img" />
                </div>
                <div className="related-posts">
                  <h2>RELATED POSTS</h2>
                  <ul>
                    <li><a href="#">Three Stone Engagement Rings</a></li>
                    <li><a href="#">Princess Cut Three Stone Engagement Rings That Celebrate This Angular Beauty</a></li>
                    <li><a href="#">Make Your Lifelong Commitment Crystal Clear with a Cushion Cut Three Stone Engagement Ring</a></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="main-content">
                ...
                <div className="gemstone-details">
                  ...
                  <img src="/images/engagementringstyle/8.jpg" alt="Pearl gemstone" className="gemstone-img" />
                </div>
                <div className="related-posts">
                  <h2>RELATED POSTS</h2>
                  <ul>
                    <li><a href="#">The Secret Glamour of the Hidden Halo</a></li>
                    <li><a href="#">Hidden Accent Engagement Ring Guide</a></li>
                    <li><a href="#">Guide to Hidden Halo Engagement Rings</a></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="main-content">
                ...
                <div className="gemstone-details">
                  ...
                  <img src="/images/engagementringstyle/9.jpg" alt="Pearl gemstone" className="gemstone-img" />
                </div>
                <div className="related-posts">
                  <h2>RELATED POSTS</h2>
                  <ul>
                    <li><a href="#">How to Integrate Something Blue into Your Engagement Ring</a></li>
                    <li><a href="#">Make your ‘something blue’ Truly Special with Blue Sapphire Accents in your Diamond Engagement Ring</a></li>
                    <li><a href="#">Something Blue, Something Borrowed Jewelry Guide</a></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="main-content PB-4" style={{borderBottom: "1px solid black" }}>
                ...
                <div className="gemstone-details">
                  ...
                  <img src="/images/engagementringstyle/10.jpg" alt="Pearl gemstone" className="gemstone-img" />
                </div>
                <div className="related-posts">
                  <h2>RELATED POSTS</h2>
                  <ul>
                    <li><a href="#">The Luxe Collection by With Clarity - it's Big, it's Bold and it's New</a></li>
                    <li><a href="#">Getting Nervous? Here's What to Say When You Propose</a></li>
                    <li><a href="#">How Long Before a Proposal Should You Buy the Ring?</a></li>
                  </ul>
                </div>
              </div>
            </div>
